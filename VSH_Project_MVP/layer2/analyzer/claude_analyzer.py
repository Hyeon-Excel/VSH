    ...
    def analyze(self, 
        ...
        try:
            message = self.client.messages.create(
                model=self.model,
                max_tokens=1024,
                system="You are a security code reviewer. Analyze the given vulnerabilities and for each one determine: 1. Is this a real threat? (Reachability) 2. What is the KISA guideline reference? 3. Provide a safe code fix. 4. Provide decision_status, confidence_score (0-100), and confidence_reason. Always respond with a JSON array. Never include markdown or code blocks in your response.",
                messages=[
